...
public class BoardDAO extends DAO {
	...
	public int countBoard() {
		...
		String sql = "select count(idx) as total from board";
		int total=0;
		try {
			conn = ds.getConnection();
			stmt = conn.createStatement();
		...
		return total;
			...
			System.out.println("countBoard 예외 : " + e.getMessage());
		} finally {
			close();
		} return 0;
	}
	...
	// 추천 기능
	public int selectRecommend(int idx, String nick) {
		String sql = "select good from recommend "
		...
		try {
			...
			System.out.println("selectRecommend 예외 : " + e.getMessage());
